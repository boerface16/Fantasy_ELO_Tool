      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-border-line">
            ...
            <th className="text-center py-2 px-2 text-xs text-text-secondary uppercase w-28">Today</th>
            <th className="text-right py-2 px-2 text-xs text-text-secondary uppercase w-20">Proj Pts</th>
          </tr>
        </thead>
        <tbody>
          {batters.map((b, idx) => {
        ...
        <tfoot>
          <tr className="border-t-2 border-border-line font-semibold">
            <td colSpan={5} className="py-2 px-2 text-text-secondary">Total</td>
