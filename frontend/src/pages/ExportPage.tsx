    ...
    <div className="space-y-6">
      ...
      <div className="bg-bg-card rounded-lg border border-border-line shadow-modern p-5">
        ...
        <textarea
          ...
          className="w-full h-40 border border-border-line rounded-md bg-bg-elevated p-3 text-sm font-mono resize-y focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
        />
      </div>
      ...
      <div className="flex items-center gap-4 flex-wrap">
        <div className="flex items-center gap-2">
          <label className="text-sm font-semibold text-text-primary">Week of:</label>
          <input
            type="date"
            value={refDate}
            onChange={(e) => setRefDate(e.target.value)}
            className="border border-border-line rounded-md bg-bg-elevated px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
          />
        </div>
        <button
      ...
      {/* Instructions */}
      <div className="bg-bg-elevated/40 rounded-lg border border-border-line p-5">
