        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {isLoading ? (
              ...
              <tr>
                <td colSpan={5} className="text-center py-12 text-gray-400">No team ELO data available</td>
              </tr>
            ) : (
              teams.map((team, idx) => {
                ...
                return (
                  <tr
                    ...
                    className="border-b border-border-line last:border-0 hover:bg-white/5 cursor-pointer transition-colors"
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="font-semibold text-gray-100">{team.teamCode}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3 text-right hidden sm:table-cell">
                      ...
                      <span className="text-gray-400 ml-1">vs {team.lastOpponent}</span>
                    </td>
                    <td className="px-4 py-3 text-right hidden sm:table-cell font-mono">
                      <span className={team.lastRunDiff > 0 ? 'text-green-400' : team.lastRunDiff < 0 ? 'text-red-400' : 'text-gray-400'}>
