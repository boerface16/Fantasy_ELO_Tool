...
# Group by (talent_type, player_role) → list of season_elo
...
print("\n\n========== PYTHON OUTPUT (paste into src/fantasy/matchup_predictor.py) ==========\n")
py_dist = {k: {"mean": v["mean"], "std": v["std"]} for k, v in elo_distribution.items()}
print(f"MLB_ELO_DISTRIBUTION: dict[str, dict[str, float]] = {repr(py_dist)}\n")
print(f"MLB_LEAGUE_AVERAGES: dict[str, float] = {repr(league_averages)}\n")
